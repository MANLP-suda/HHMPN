...
def run_model(model, train_data, valid_data, test_data, crit, optimizer,adv_optimizer,scheduler, opt, data_dict):
	...
	if opt.test_only:
		...
		test_loss = test_loss/len(test_data._src_text_insts)
	...
	for epoch_i in range(opt.epoch):
		...
		train_loss = train_loss/len(train_data._src_text_insts)
		...
		# me=evals.get_metrics(all_predictions,all_targets)
		...
		valid_loss = valid_loss/len(valid_data._src_text_insts)
